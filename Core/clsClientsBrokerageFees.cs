...
namespace Core
{
    public class clsClientsBrokerageFees
    {
        ...
        private float _fltBrokerageFeesDiscount;
        private float _fltTicketFeesDiscount;
        private float _fltBrokerageFeesBuy;
        private float _fltBrokerageFeesSell;
        ...
        private int _iError_ID;
        private DataTable _dtList;

        public clsClientsBrokerageFees()
        {
            this._iRecord_ID = 0;
            ...
            this._fltBrokerageFeesDiscount = 0;
            this._fltTicketFeesDiscount = 0;
            this._fltBrokerageFeesBuy = 0;
            this._fltBrokerageFeesSell = 0;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "ClientsBrokerageFees"));
                ...
                while (drList.Read())
                {
                    ...
                    this._fltBrokerageFeesDiscount = Convert.ToSingle(drList["BrokerageFeesDiscount"]);
                    this._fltTicketFeesDiscount = Convert.ToSingle(drList["TicketFeesDiscount"]);
                    this._fltBrokerageFeesBuy = Convert.ToSingle(drList["BrokerageFeesBuy"]);
                    this._fltBrokerageFeesSell = Convert.ToSingle(drList["BrokerageFeesSell"]);
        ...
        public void GetList()
        {
            try
            {
                ...
                if (_bIncludeDiscount)
                {
                    ...
                    cmd = new SqlCommand("GetContract_BrokerageFees", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    while (drList.Read())
                    {
                        ...
                        if (foundRows.Length > 0)
                        {
                            ...
                            foundRows[0]["FeesDiscountPercent"] = drList["BrokerageFeesDiscount"];
                            foundRows[0]["TicketFeesDiscountPercent"] = drList["TicketFeesDiscount"];
                            foundRows[0]["FinishBuyFeesPercent"] = drList["BrokerageFeesBuy"];
                            foundRows[0]["FinishSellFeesPercent"] = drList["BrokerageFeesSell"];
        ...
        public void GetFees()
        {
            try
            {
                ...
                conn.Open();
                cmd = new SqlCommand("GetBrokerage_Fees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@Contract_ID", _iContract_ID));
                ...
                cmd.Parameters.Add(new SqlParameter("@Quantity", _iQuantity));
                ...
                {
                    cmd = new SqlCommand("GetBrokerage_Fees_Discount", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@Contract_ID", _iContract_ID));
                    ...
                    while (drList.Read())
                    {
                        ...
                        dtRow["FeesDiscountPercent"] = drList["BrokerageFeesDiscount"];
                        dtRow["TicketFeesDiscountPercent"] = drList["TicketFeesDiscount"];
                        dtRow["FinishBuyFeesPercent"] = drList["BrokerageFeesBuy"];
                        dtRow["FinishSellFeesPercent"] = drList["BrokerageFeesSell"];
        ...
        public void CheckTransactionFees()
        {
            ...
            try
            {
                ...
                while (drList.Read())
                {
                    _iError_ID = Convert.ToInt32(drList["Error_num"]);
                }
                drList.Close();
            }
            catch (Exception ex) { MessageBox.Show(ex.Message, Global.AppTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation); }
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("InsertClientsBrokerageFees", conn))
                {
                    ...
                    cmd.Parameters.Add("@BrokerageFeesDiscount", SqlDbType.Float).Value = _fltBrokerageFeesDiscount;
                    cmd.Parameters.Add("@TicketFeesDiscount", SqlDbType.Float).Value = _fltTicketFeesDiscount;
                    cmd.Parameters.Add("@BrokerageFeesBuy", SqlDbType.Float).Value = _fltBrokerageFeesBuy;
                    cmd.Parameters.Add("@BrokerageFeesSell", SqlDbType.Float).Value = _fltBrokerageFeesSell;
        ...
        public void EditRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("EditClientsBrokerageFees", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "ClientsBrokerageFees";
        ...
        public float BrokerageFeesDiscount { get { return this._fltBrokerageFeesDiscount; } set { this._fltBrokerageFeesDiscount = value; } }
        public float TicketFeesDiscount { get { return this._fltTicketFeesDiscount; } set { this._fltTicketFeesDiscount = value; } }
        public float BrokerageFeesBuy { get { return this._fltBrokerageFeesBuy; } set { this._fltBrokerageFeesBuy = value; } }
        public float BrokerageFeesSell { get { return this._fltBrokerageFeesSell; } set { this._fltBrokerageFeesSell = value; } }
        ...
        public int Quantity { get { return this._iQuantity; } set { this._iQuantity = value; } }
        public int Error_ID { get { return this._iError_ID; } set { this._iError_ID = value; } }
