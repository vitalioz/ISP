...
namespace Core
{
    public class clsStockExchanges_Alias
    {
        ...
        public clsStockExchanges_Alias()
        {
            this._iRecord_ID = 0;
            this._iItem_ID = 0;
        ...
        public void GetList()
        {
            ...
            {
                conn.Open();
                cmd = new SqlCommand("GetStockExchanges_Alias_List", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("InsertStockExchanges_Alias", conn))
                {
        ...
        public void EditRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("EditStockExchanges_Alias", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "StockExchanges_Alias";
