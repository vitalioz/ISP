...
namespace Core
{
    public class clsServiceProviderBrokerageFees
    {
        ...
        public clsServiceProviderBrokerageFees()
        {
            this._iRecord_ID = 0;
            this._iSPO_ID = 0;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "ServiceProviderBrokerageFees"));
        ...
        public void GetFees()
        {
            try
            {
                ...
                conn.Open();        
                cmd = new SqlCommand("GetServiceProviderBrokerageFees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("sp_InsertServiceProviderBrokerageFees", conn))
                {
        ...
        public int EditRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("sp_EditServiceProviderBrokerageFees", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "ServiceProviderBrokerageFees";
