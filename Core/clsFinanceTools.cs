    ...
    public class clsFinanceTools
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "FinanceTools"));
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertFinanceTool", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "FinanceTools";
