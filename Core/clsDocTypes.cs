    ...
    public class clsDocTypes
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "DocTypes"));
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("InsertDocTypes", conn))
                {
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Title", SqlDbType.NVarChar, 80).Value = this._sTitle;
                    cmd.ExecuteNonQuery();
        ...
        public void EditRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("EditDocTypes", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "DocTypes";
