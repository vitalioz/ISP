...
namespace Core
{
    public partial class ucProducts_Fund : UserControl
    {
        DataView dtView;
        ...
        private void ucProducts_Fund_Load(object sender, EventArgs e)
        {
