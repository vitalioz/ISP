...
namespace Core
{
    public class clsServiceProviderDiscretFees
    {
        ...
        public clsServiceProviderDiscretFees()
        {
            this._iRecord_ID = 0;
            this._iSPO_ID = 0;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "ServiceProviderDiscretFees"));
        ...
        public void GetFees()
        {
            try
            {
                _dtList = new DataTable("ServiceProviderDiscretFees_List");
                ...
                conn.Open();
                cmd = new SqlCommand("GetServiceProviderDiscretFees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("InsertServiceProviderDiscretFees", conn))
                {
        ...
        public int EditRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("EditServiceProviderDiscretFees", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "ServiceProviderDiscretFees";
