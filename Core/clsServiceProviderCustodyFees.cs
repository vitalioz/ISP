...
namespace Core
{
    public class clsServiceProviderCustodyFees
    {
        ...
        public clsServiceProviderCustodyFees()
        {
            this._iRecord_ID = 0;
            this._iSPO_ID = 0;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "ServiceProviderCustodyFees"));
        ...
        public void GetList()
        {
            try
            {
                _dtList = new DataTable("ServiceProviderCustodyFees_List");
                ...
                conn.Open();
                cmd = new SqlCommand("GetPackage_ServiceProviderCustodyFees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void GetFees()
        {
            try
            {
                ...
                conn.Open();
                cmd = new SqlCommand("GetServiceProviderCustodyFees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("sp_InsertServiceProviderCustodyFees", conn))
                {
        ...
        public int EditRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("sp_EditServiceProviderCustodyFees", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "ServiceProviderCustodyFees";
