    ...
    public class clsTrxActions
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "Trx_Actions"));
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertTrxActions", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "Trx_Actions";
