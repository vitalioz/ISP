...
namespace Core
{
    public class clsTrxClientsFees
    {
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertTrxClientsFees", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "Trx_ClientsFees";
