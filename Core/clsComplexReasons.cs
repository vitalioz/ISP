...
namespace Core
{
    public class clsComplexReasons
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "ComplexReasons"));
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertComplexReasons", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "ComplexReasons";
