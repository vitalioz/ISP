...
namespace Core
{
    public class clsCouponeTypes
    {
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertCouponeTypes", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "CouponeTypes";
