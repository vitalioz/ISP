    ...
    public class clsDivisions
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "Divisions"));
                ...
                while (drList.Read())
                {
                    ...
                    this._sTel = drList["Tel"].ToString();
                }
            }
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertDivisions", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "Divisions";
