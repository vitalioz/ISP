    ...
    public class clsHFCategories
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "HFCategories"));
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertHFCategories", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "HFCategories";
