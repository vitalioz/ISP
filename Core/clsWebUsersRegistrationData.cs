...
namespace Core
{
    public class clsWebUsersRegistrationData
    {
        ...
        public clsWebUsersRegistrationData()
        {
            this._iRecord_ID = 0;
            this._iWU_ID = 0;
            this._iClient_ID = 0;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "WebUsersRegistrationData"));
        ...
        public void GetList()
        {
            ...
            _dtList.Columns.Add("sEmail", typeof(string));
            _dtList.Columns.Add("sMobile", typeof(string));
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("GetWebUsersRegistrationData", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertRecord()
        {
            try
            {
                conn = new SqlConnection(Global.connStr);
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("InsertWebUsersRegistrationData", conn))
                {
        ...
        public int EditRecord()
        {
            try
            {
                conn = new SqlConnection(Global.connStr);
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("EditWebUsersRegistrationData", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "WebUsersRegistrationData";
