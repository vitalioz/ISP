...
namespace Core
{
    public partial class ucProducts_Indexes : UserControl
    {
        DataView dtView;
        ...
        private void ucProducts_Indexes_Load(object sender, EventArgs e)
        {
            lblISIN_Warning.Text = "";
