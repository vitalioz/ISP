...
namespace Core
{
    public class clsRMJobs
    {
        ...
        private int _iInformMethod;
        private int _iSource_ID;
        private int _iClient_ID;
        private int _iClientPackage_ID;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                while (drList.Read())
                {
                    this._iCommand_Type = Convert.ToInt32(drList["Tipos"]);
                    ...
                    this._iClientPackage_ID = Convert.ToInt32(drList["ClientPackage_ID "]);
            ...
            try
            {
                ...
                while (drList.Read())
                {
                    _dtList.Rows.Add(drList["ID"], drList["Command_Type"], drList["Command_ID"], drList["InformMethod"], drList["Source_ID"],
                                     drList["Client_ID"], drList["Contract_ID"], drList["CC"], drList["Subject"], drList["Body"],
        ...
        public int CheckJobsExisting()
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@Table", "RMJobs"));
                cmd.Parameters.Add(new SqlParameter("@Col", "Client_ID"));
                cmd.Parameters.Add(new SqlParameter("@Value", _iClient_ID));
                cmd.Parameters.Add(new SqlParameter("@Order", ""));
                drList = cmd.ExecuteReader();
                while (drList.Read())
                {
                    if (drList.HasRows) j = 7;
                }
            }
            catch (Exception ex) { MessageBox.Show(ex.Message, Global.AppTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation); }
            finally { conn.Close(); }
        ...
        public int InsertRecord()
        {
            try
            {
                ...
                using (cmd = new SqlCommand("sp_InsertInformings", conn))
                {
                    ...
                    cmd.Parameters.Add("@ClientPackage_ID", SqlDbType.Int).Value = _iClientPackage_ID;
                    cmd.Parameters.Add("@ClientData", SqlDbType.NVarChar, 100).Value = _sClientData;
                    cmd.Parameters.Add("@CC", SqlDbType.NVarChar, 100).Value = _sCC;
                    cmd.Parameters.Add("@Subject", SqlDbType.NVarChar, 100).Value = _sSubject;
                    cmd.Parameters.Add("@Body", SqlDbType.NVarChar, 100).Value = _sBody;
                    cmd.Parameters.Add("@FileName", SqlDbType.NVarChar, 100).Value = _sFileName;
                    cmd.Parameters.Add("@AttachedFiles", SqlDbType.NVarChar, 100).Value = _sAttachedFiles;
        ...
        public int ClientPackage_ID { get { return _iClientPackage_ID; } set { _iClientPackage_ID = value; } }
        ...
        public string CC { get { return _sClientData; } set { _sClientData = value; } }
