...
namespace Core
{
    public class clsCheckProblems
    {
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("InsertCommands_CheckProblems", conn))
                {
        ...
        public void EditRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("EditCommands_CheckProblems", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "Commands_CheckProblems";
