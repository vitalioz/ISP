...
namespace Core
{
    public class clsRevocationRights
    {
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InsertRevocationRights", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "RevocationRights";
