...
namespace Core
{
    public class clsServiceProviderAdminFees
    {
        ...
        public clsServiceProviderAdminFees()
        {
            this._iRecord_ID = 0;
            this._iSPO_ID = 0;
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "ServiceProviderAdministrationFees"));
                ...
                while (drList.Read())
                {
                    ...
                    this._fltRetrosessionProvider = Convert.ToInt32(drList["RetrosessionProvider"]);
        ...
        public void GetList()
        {
            try
            {
                _dtList = new DataTable("ServiceProviderAdminFees_List");
                ...
                conn.Open();
                cmd = new SqlCommand("GetPackage_ServiceProviderAdminFees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void GetFees()
        {
            try
            {
                ...
                conn.Open();
                cmd = new SqlCommand("GetServiceProviderAdministrationFees", conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("sp_InsertServiceProviderAdministrationFees", conn))
                {
        ...
        public int EditRecord()
        {
            ...
            {
                conn.Open();
                using (cmd = new SqlCommand("sp_EditServiceProviderAdministrationFees", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "ServiceProviderAdministrationFees";
