...
namespace Core
{
    public class clsCountriesGroups
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "CountriesGroups"));
        ...
        public void InsertRecord()
        {
            ...
            using (var command = new SqlCommand("InserCountriesGroups", conn)
            {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "CountriesGroups";
