...
namespace Core
{
    public class clsCustodyFees_Recs
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "CustodyFees_Recs"));
                ...
                while (drList.Read())
                {
                    ...
                    this._iCT_ID = Convert.ToInt32(drList["CT_ID"]);
        ...
        public void GetList()
        {
            try
            {
                ...
                dtCol = _dtList.Columns.Add("CT_ID", Type.GetType("System.Int32"));
                ...
                dtCol = _dtList.Columns.Add("Statement_File", Type.GetType("System.String"));
                dtCol = _dtList.Columns.Add("Misc_File", Type.GetType("System.String"));
                dtCol = _dtList.Columns.Add("Advisor_Email", Type.GetType("System.String"));

                conn.Open();
                cmd = new SqlCommand("GetCustodyFees_List", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@CT_ID", _iCT_ID));
                drList = cmd.ExecuteReader();
                while (drList.Read())
                {
                    ...
                    dtRow["InvestmentPolicy"] = drList["InvestmentPolicy_Title"] + "";
                    dtRow["InvestmentProfile"] = drList["InvestmentProfile_Title"] + "";
                    ...
                    dtRow["Statement_File"] = drList["Statement_File"] + "";
                    dtRow["Misc_File"] = drList["Misc_File"] + "";
                    dtRow["Advisor_Email"] = drList["Advisor_Email"] + "";
        ...
        public void CheckRecord()
        {
            ...
            {
                conn.Open();
                cmd = new SqlCommand("GetCustodyFees_CheckRecord", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@CT_ID", _iCT_ID));
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("InsertCustodyFees_Rec", conn))
                {
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@CT_ID", SqlDbType.Int).Value = _iCT_ID;
        ...
        public void EditRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("EditCustodyFees_Rec", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int CT_ID { get { return this._iCT_ID; } set { this._iCT_ID = value; } }
