...
namespace Core
{
    public class clsOrdersLL_Check
    {
        ...
        public void GetRecord()
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Table", "CommandsLL_Check"));
        ...
        public void GetList()
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@ID", this._iCommandLL_ID));
                drList = cmd.ExecuteReader();
                while (drList.Read())
                {
                    _dtList.Rows.Add(drList["ID"], drList["CommandLL_ID"], drList["DateIns"], drList["User_ID"], drList["Status"], drList["ProblemType_ID"],
        ...
        public int InsertRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("sp_InsertCommandsLL_Check", conn))
                {
        ...
        public void EditRecord()
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("sp_EditCommandsLL_Check", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Table", SqlDbType.NVarChar, 100).Value = "CommandsLL_Check";
